...
class Ui_Cam(object):
    def setupUi(self, Cam):
        ...
        sizePolicy.setHeightForWidth(self.save_location_label.sizePolicy().hasHeightForWidth())
        self.save_location_label.setSizePolicy(sizePolicy)
        ...
        self.settings_pushButton = QtWidgets.QPushButton(Cam)
        self.settings_pushButton.setMinimumSize(QtCore.QSize(80, 0))
        self.settings_pushButton.setMaximumSize(QtCore.QSize(16777215, 23))
    ...
    def retranslateUi(self, Cam):
        ...
        self.settings_pushButton.setToolTip(_translate("Cam", "Camera settings"))
        self.settings_pushButton.setText(_translate("Cam", "Settings"))
