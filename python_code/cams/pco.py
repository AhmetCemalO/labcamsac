...
class PCOCam(GenericCam):
    ...
    def __init__(self, cam_id = None, outQ = None,
        ...
        super().__init__(name = 'PCO', cam_id = cam_id, outQ = outQ, recorderpar=recorderpar)
        self.armed = False
        if dllpath is None:
    ...
    def _init_controls(self):
        self.ctrevents = dict(exposure=dict(function = 'set_exposure_time',
                                            widget = 'float',
                                            variable = 'exposure',
                                            units = 'ms',
                                            type = 'float',
    ...
    def camopen(self,cam_id,reset = False):
        '''Open PCO camera'''
        ...
        ret = opencamera(self.hCam, cam_id)
        if ret == 0 and reset:
    ...
    def _cam_loop(self,poll_timeout=5e7):
        ...
        if not which_buf is None:
            ...
            return True, self.out.copy(),(frameID,timestamp)
